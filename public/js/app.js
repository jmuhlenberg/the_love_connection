...
class App extends React.Component {
  ...
  getMatches = (event) => {
    ...
    axios.get(`/user/${this.state.currUse}`).then(
      (response) => {
        console.log('-------getMatches----------', response.data);
        this.setState({
        ...
        <div className='signUp'>
            ...
            <details>
              <form onSubmit={this.handleSubmit}>
                ...
                // <FormControl className={this.handleChange}>
                ...
                //   />
                //     // <MenuItem value='young'>18-25</MenuItem>
                //     // <MenuItem value='golden'>26-35</MenuItem>
                //     // <MenuItem value='sunset'>36-40</MenuItem>
                //     // <MenuItem value='adults'>41-48</MenuItem>
                //     // <MenuItem value='mature'>49+</MenuItem>
                //
                // </FormControl>
                // </div>
                <br/>
